...
* After you done editing your function, open command line tool inside of `./LambdaFunction`
...
You define you main function in the handler field. In this case, main method is `Handler`. It takes two parameters - input from CodeMash and function configuration.
...
CodeMash will always return `CustomEventRequest` as an input object. This class takes in generic parameter defining one of the possible input type. The following tables explains when to use each of the provided inputs.
...
A line below shows how to get environment variables that you have set up near your function.
